...
public class WeixinUtil {
	...
	public final static String access_token_fwh_url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=APPID&secret=APPSECRET";
	...
	public final static String getuserinfo_fwh_url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=APPID&secret=SECRET&code=CODE&grant_type=authorization_code";
	 ...
	 * @author 曾鸣 zengming@edujoy.com.cn
	 */
	public static AccessToken getFWHAccessToken(String appid, String appsecret) {
		AccessToken accessToken = null;
		String requestUrl = access_token_fwh_url.replace("APPID", appid)
	 ...
	 * @author 曾鸣 zengming@edujoy.com.cn
	 */
	public static WXUserInfo getUserInfoFromFWH(String appid, String appsecret,
			String code) {
		WXUserInfo userInfo = null;
		String requestUrl = getuserinfo_fwh_url.replace("APPID", appid)
		...
		if (null != jsonObject) {
			try {
				userInfo = new WXUserInfo();
				userInfo.setWx_user_id(jsonObject.getString("unionid"));
				userInfo.setDevice_id(jsonObject.getString("openid"));
				log.error("根据code获取成员信息 unionid:{} openid:{}",
